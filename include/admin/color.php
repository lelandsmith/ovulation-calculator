...
<h3>This is where you edit color of calendar.</h3><hr>
<table class="form-table">
	<tbody>
		...
		<tr valign="top">
		<th scope="row"><?php _e('Email Box Background Color', 'ovulationcalculator-group');?></th>
		<td>
			<input type="text" name="ovulationcalculator-group[oc-email-box-bg]" value="<?php echo (!empty($options['oc-email-box-bg'])) ?  $options['oc-email-box-bg'] : '#e6e6e6'?>" class="oc-email-box-bg" data-default-color="#e6e6e6"/>
		</td>
		</tr>
				
		<tr valign="top">
		<th scope="row"><?php _e('Text Color', 'ovulationcalculator-group');?></th>
		<td>
			<input type="text" name="ovulationcalculator-group[oc-email-box-text]" value="<?php echo (!empty($options['oc-email-box-text'])) ?  $options['oc-email-box-text'] : '#544f49'?>" class="oc-email-box-text" data-default-color="#544f49"/>
		</td>
		</tr>
	</tbody>
</table>
