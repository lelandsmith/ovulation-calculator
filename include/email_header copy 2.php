								...
								<td align="left" valign="top">
									<div class="email-ovulation-dates">
										...
										<?php 
											...
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[0]));?></b>
											
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[5]));?></b>
											<br>
											<b><?php printf(__('%s', 'ovulation-calculator'), $options['oc-email-header-ovulation-text']);?> 2:&nbsp;&nbsp;&nbsp;&nbsp;</b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[6]));?></b>
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[11]));?></b>
											<br>
											<b><?php printf(__('%s', 'ovulation-calculator'), $options['oc-email-header-ovulation-text']);?> 3:&nbsp;&nbsp;&nbsp;&nbsp;</b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[12]));?></b>
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[17]));?></b>
											<br>
											<b><?php printf(__('%s', 'ovulation-calculator'), $options['oc-email-header-ovulation-text']);?> 4:&nbsp;&nbsp;&nbsp;&nbsp;</b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[18]));?></b>
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[23]));?></b>
											<br>
											<b><?php printf(__('%s', 'ovulation-calculator'), $options['oc-email-header-ovulation-text']);?> 5:&nbsp;&nbsp;&nbsp;&nbsp;</b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[24]));?></b>
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[29]));?></b>
											<br>
											<b><?php printf(__('%s', 'ovulation-calculator'), $options['oc-email-header-ovulation-text']);?> 6:&nbsp;&nbsp;&nbsp;&nbsp;</b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[30]));?></b>
											<b> - </b>
											<b><?php echo strftime( "%B %d, %Y",strtotime($fertile_result_for_email[35]));?></b>
											<br>
										</div>
									</div>
								</td>		
